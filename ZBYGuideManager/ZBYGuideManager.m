...
@interface ZBYGuideManagerCell : UICollectionViewCell
...
@implementation ZBYGuideManagerCell
...
@interface ZBYGuideManager ()<UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate>
...
@implementation ZBYGuideManager{
...
+ (instancetype)shared {
    ...
    dispatch_once(&onceToken, ^{
        __staticObject = [ZBYGuideManager new];
    });
...
- (UICollectionView *)view {
    if (_view == nil) {
        ...
        [_view registerClass:[ZBYGuideManagerCell class] forCellWithReuseIdentifier:identifier];
    }
    return _view;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZBYGuideManagerCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
